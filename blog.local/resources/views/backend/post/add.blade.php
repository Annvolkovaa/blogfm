        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-table"></i> Добавить новость
              <a href="{{url('admin/post')}}" class="float-right btn btn-sm btn-dark">Все данные</a>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                ...
                <form method="post" action="{{url('admin/post')}}" enctype="multipart/form-data">
                  ...
                  <table class="table table-bordered">
                      <tr>
                          <th>Категория<span class="text-danger">*</span></th>
                          <td>
                      ...
                      <tr>
                          <th>Детальное описание<span class="text-danger">*</span></th>
                          <td>
